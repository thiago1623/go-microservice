...
# CSV file path on your local machine
csv_file="/home/thiago/Documents/Golang/go-microservice/test_bia.csv" # Replace this path with your own CSV file path

# Copy csv file to db container (assuming the container name is "db_go_testing")
docker cp "$csv_file" db_go_testing:/test_bia.csv

# Run command inside db container to create tables and import data
